...
const Hero = () => {
  return (
    <div id="intro" className="relative overflow-hidden">
      {/* Decorative elements */}
      <div className="hidden sm:block sm:absolute sm:inset-0 sm:opacity-30 dark:sm:opacity-20 pointer-events-none">
        <svg
      ...
      {/* API Stats */}
      <div className="bg-muted py-12 animate-fade-in" style={{ animationDelay: "0.3s" }}>
